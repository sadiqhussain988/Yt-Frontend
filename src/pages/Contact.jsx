...
export default function ContactSection() {
  ...
  const socialLinks = [
    ...
    { icon: <FaLinkedinIn />, link: "#", color: "hover:bg-blue-600 " },
  ];
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.name || !formData.email || !formData.message) {
      toast.error("Please fill in all fields!", { position: "top-right", theme: "colored" });
      return;
    }
  ...
  return (
    <>
      ...
      <section
        id="contact"
        className="py-15 md:py-20 bg-gradient-to-br from-[#0A043C] to-[#12007E] text-white overflow-hidden overflow-x-hidden relative"
      >
        <ToastContainer
          position="top-right"
          autoClose={3000}
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-12">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div
                  data-aos="zoom-in"
                  data-aos-delay="300"
                  className="flex items-start p-5 rounded-xl bg-[#12007E]/30 hover:bg-[#12007E]/50 transition-all duration-300 hover:scale-105 shadow-md"
                >
                  <HiLocationMarker className="text-amber-400 mt-1 mr-4 text-2xl" />
                  <div>
                    <h3 className="font-bold text-lg text-amber-300">Address</h3>
                    <p className="text-gray-300">3 Marla Housing Scheme, 100 Fota Road, Islami Colony, Bahawalpur</p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">+92 320 0639360</p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">usamaupwork0003@gmail.com</p>
                  </div>
                </div>
              </div>
            ...
            <div
              data-aos="fade-left"
              data-aos-delay="300"
              className="bg-gradient-to-br from-[#0A043C]/90 to-[#0f00aa]/90 p-6 md:p-8 rounded-2xl shadow-2xl border border-[#1e1b7b]"
            >
              <h3
                data-aos="fade-down"
                data-aos-delay="400"
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white font-bold py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg"
